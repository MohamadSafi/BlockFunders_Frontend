        ...
        <div>
          <h3 className="text-4xl md:text-6xl font-semibold">
            <p className="leading-tight">
              Create & Meet <span className="text-[#65b2f0]">dreams</span> with{" "}
              <span className="gradient-text">BlockFunders</span>
            </p>
          </h3>
          <p className="text-base md:text-lg text-slate-700 my-4 md:my-6">
            Help someone meet their dream with BlockFunders. Leveraging
